...
Upon entering the folder named after your group id, you will find a file Group_Members.txt, add the names and enrollment numbers of each member of your group to that file. Also upload the yours passport size photo(File name is yours EnrollmentNumber_FullName) 
